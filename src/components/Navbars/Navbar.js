...
const Navbar = () => {
  ...
  const handleMenu = () => {
    setMobMenu(!mobMenu);       // Toggles the mobile menu state.
    if (!mobMenu) {
      body.style.overflow = "hidden";       // Prevents scrolling when the menu is open.
    }
    if (mobMenu) {
      body.style.overflow = "auto";       // Re-enables scrolling when the menu is closed.
    }
  };
    ...
    <>
      <nav className="navbar bg-[#003247]">
        ...
        <div
          className={
            mobMenu
              ? "md:hidden ease-in-out duration-500  overflow-y-hidden absolute left-0 navMobile bg-[#003247] h-screen w-full z-20 px-5 py-8"
        ...
        >
          ...
          <ul className="flex justify-center py-2">
            <li className='social-links font-["Manrope"] text-white mx-5 text-l my-4 '>
              <a href="https://www.facebook.com/prastuti.iitbhu">
                <IconContext.Provider value={{ className: "react-icons" }}>
            ...
            <li className='social-links font-["Manrope"] justify-center text-white mx-5 text-l my-4 '>
              <a href="https://www.instagram.com/prastuti.iitbhu/">
                <IconContext.Provider value={{ className: "react-icons" }}>
            ...
            <li className='social-links font-["Manrope"] text-white mx-5 text-l my-4 '>
              <a href="https://www.linkedin.com/company/prastuti/">
                <IconContext.Provider value={{ className: "react-icons" }}>
            ...
            <li className="social-links font-['Manrope'] text-white mx-5 text-l my-4">
              <a href="https://github.com/Prastuti-Fest-IIT-BHU">
                <IconContext.Provider value={{ className: "react-icons" }}>
